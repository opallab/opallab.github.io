...
<div class="col-sm-6 clearfix">
 <div class="well">
  ...
  <p><strong><a href="{{ publi.code.url }}">{{ publi.code.display }}</a></strong></p>
  <p><strong><a href="{{ site.url }}{{ site.baseurl }}/downloads/slides/{{ publi.slides.url }}">{{ publi.slides.display }}</a></strong></p>
